...
describe("Probando el servicio de User", () => {
    ...
    it("Debería de regresa true al actualizar el registro de forma satisfactoria", async () => {
        //AAA
        //Arrange
    ...
    it("Debería de regresa true al eliminar el registro de forma satisfactoria", async () => {
        //AAA
        //Arrange
        //Act
